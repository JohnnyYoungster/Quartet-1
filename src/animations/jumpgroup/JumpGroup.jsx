import "./jumpgroup.css"
import React from "react"
import TweenOne from "rc-tween-one";
import avatar1 from '../../image/avatar1.png'
import avatar2 from '../../image/avatar2.png'
import userAva from '../../image/userAvatar.png'
import JoinJumpGroup from '../joinjumpgroup/JoinJumpGroup';
...
export default class JumpGroup extends React.Component {
  constructor(props) {
    super(props);
    this.animation = [
      {
      ...
      <div className="jumpingGroup">
        <TweenOne
          ...
          >
            ...
            <img className="avatar9" src={userAva} alt="avatar2" />
